        ...
        <div className="min-h-screen bg-gradient-to-br from-blue-100 to-indigo-100 py-12 px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-md overflow-hidden">
            <div className="bg-indigo-600 px-6 py-4">
              ...
              <p className="mt-1 text-indigo-200">Information about the user and their activities.</p>
            </div>
                          ...
                          {user.cart.map((item, index) => (
                            <li key={index} className="bg-white p-3 rounded shadow-sm">
                              <div className="flex justify-between items-center">
                                <span className="font-medium text-indigo-600">{item.packageName}</span>
                                <span className="text-gray-600">
                                  ${item.cost} for {item.duration} days
                                </span>
                              </div>

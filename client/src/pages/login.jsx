...
const Login = () => {
  ...
  const onSubmitHandler = async (e) => {
    ...
    try {
      ...
      if (state === 'sign up') {
        const { data } = await axios.post(`https://host-cycle-ji9x.vercel.app/api/auth/register`, {
          name,
          email,
          password,
          Contry,
        ...
        const { data } = await axios.post(`https://host-cycle-ji9x.vercel.app/api/auth/login`, {
          email,
          password,
        });
        if (data.success) {
